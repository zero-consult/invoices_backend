...
import org.zero_consult.payslip_backend.configuration.MockableClock;
import org.zero_consult.payslip_backend.entities.InvoiceDiscriminator;
import org.zero_consult.payslip_backend.entities.InvoicingMonth;
...
import org.zero_consult.payslip_backend.repositories.InvoicingMonthRepository;
...
public class InvoicingMonthService {
    ...
    public LocalDate closeCurrentPayslipMonth() throws ServiceUnavailableException, CloseMonthConstraintException {
        ...
        try {
            List<TimesheetEntry> timesheetEntries = timesheetApiService.getTimesheetApi().timesheetsList(payslipMonth, payslipMonth.plusMonths(1), null);
